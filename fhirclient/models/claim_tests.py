...
class ClaimTests(unittest.TestCase):
    ...
    def implClaim2(self, inst):
        ...
        self.assertEqual(inst.priority.coding[0].code, "normal")
        self.assertEqual(inst.status, "active")
        self.assertEqual(inst.supportingInfo[0].category.coding[0].code, "missingtooth")
        ...
        self.assertEqual(inst.supportingInfo[0].code.coding[0].code, "15")
        self.assertEqual(inst.supportingInfo[0].code.coding[0].system, "http://terminology.hl7.org/CodeSystem/ex-tooth")
        self.assertEqual(inst.supportingInfo[0].reason.coding[0].code, "e")
        self.assertEqual(inst.supportingInfo[0].reason.coding[0].system, "http://terminology.hl7.org/CodeSystem/missingtoothreason")
        ...
        self.assertEqual(inst.supportingInfo[1].category.coding[0].code, "exception")
        ...
        self.assertEqual(inst.supportingInfo[1].code.coding[0].code, "student")
        self.assertEqual(inst.supportingInfo[1].code.coding[0].system, "http://terminology.hl7.org/CodeSystem/claim-exception")
        self.assertEqual(inst.supportingInfo[1].sequence, 2)
        self.assertEqual(inst.supportingInfo[1].valueString, "Happy Valley Community College")
    ...
    def implClaim3(self, inst):
        ...
        self.assertEqual(inst.item[0].locationCodeableConcept.coding[0].system, "http://terminology.hl7.org/CodeSystem/ex-serviceplace")
        self.assertEqual(inst.item[0].net.currency, "USD")
        self.assertEqual(inst.item[0].net.value, 1050.0)
        self.assertEqual(inst.item[0].productOrService.coding[0].code, "67221")
        self.assertEqual(inst.item[0].productOrService.coding[0].display, "Maryland Bridge")
        self.assertEqual(inst.item[0].productOrService.coding[0].system, "http://example.org/fhir/oralservicecodes")
        self.assertEqual(inst.item[0].sequence, 1)
        self.assertEqual(inst.item[0].servicedDate.date, FHIRDate("2014-08-16").date)
        self.assertEqual(inst.item[0].servicedDate.as_json(), "2014-08-16")
        ...
        self.assertEqual(inst.item[1].locationCodeableConcept.coding[0].system, "http://terminology.hl7.org/CodeSystem/ex-serviceplace")
        self.assertEqual(inst.item[1].net.currency, "USD")
        self.assertEqual(inst.item[1].net.value, 105.0)
        self.assertEqual(inst.item[1].productOrService.coding[0].code, "21211")
        self.assertEqual(inst.item[1].productOrService.coding[0].system, "http://example.org/fhir/oralservicecodes")
        ...
        self.assertEqual(inst.item[2].locationCodeableConcept.coding[0].system, "http://terminology.hl7.org/CodeSystem/ex-serviceplace")
        self.assertEqual(inst.item[2].net.currency, "USD")
        self.assertEqual(inst.item[2].net.value, 1100.0)
        ...
        self.assertEqual(inst.related[0].relationship.coding[0].system, "http://terminology.hl7.org/CodeSystem/ex-relatedclaimrelationship")
        self.assertEqual(inst.status, "active")
        self.assertEqual(inst.supportingInfo[0].category.coding[0].code, "prosthesis")
        self.assertEqual(inst.supportingInfo[0].category.coding[0].system, "http://terminology.hl7.org/CodeSystem/claiminformationcategory")
        self.assertEqual(inst.supportingInfo[0].code.coding[0].code, "2")
        self.assertEqual(inst.supportingInfo[0].code.coding[0].display, "Maryland Bridge")
        self.assertEqual(inst.supportingInfo[0].code.coding[0].system, "http://hl7.org/fhir/ex-oralprostho")
        self.assertEqual(inst.supportingInfo[0].sequence, 1)
    ...
    def implClaim5(self, inst):
        ...
        self.assertEqual(inst.item[0].productOrService.coding[0].code, "smokecess")
        self.assertEqual(inst.item[0].productOrService.coding[0].system, "http://hl7.org/fhir/ex-pharmaservice")
        self.assertEqual(inst.item[0].sequence, 1)
        self.assertEqual(inst.item[0].servicedDate.date, FHIRDate("2014-08-16").date)
        self.assertEqual(inst.item[0].servicedDate.as_json(), "2014-08-16")
        self.assertEqual(inst.item[0].unitPrice.currency, "USD")
    ...
    def implClaim9(self, inst):
        ...
        self.assertEqual(inst.item[0].detail[0].productOrService.coding[0].code, "44001")
        self.assertEqual(inst.item[0].detail[0].productOrService.coding[0].display, "Acetaminophen 250mg")
        self.assertEqual(inst.item[0].detail[0].productOrService.coding[0].system, "http://localdruglist.org")
        self.assertEqual(inst.item[0].detail[0].quantity.unit, "mg")
        self.assertEqual(inst.item[0].detail[0].quantity.value, 250)
        self.assertEqual(inst.item[0].detail[0].sequence, 1)
        self.assertEqual(inst.item[0].detail[0].subDetail[0].net.currency, "USD")
        self.assertEqual(inst.item[0].detail[0].subDetail[0].net.value, 20.0)
        self.assertEqual(inst.item[0].detail[0].subDetail[0].productOrService.coding[0].code, "drugcost")
        self.assertEqual(inst.item[0].detail[0].subDetail[0].productOrService.coding[0].system, "http://hl7.org/fhir/ex-pharmaservice")
        self.assertEqual(inst.item[0].detail[0].subDetail[0].sequence, 1)
        self.assertEqual(inst.item[0].detail[1].net.currency, "USD")
        self.assertEqual(inst.item[0].detail[1].net.value, 25.0)
        self.assertEqual(inst.item[0].detail[1].productOrService.coding[0].code, "44035")
        self.assertEqual(inst.item[0].detail[1].productOrService.coding[0].display, "Phenacetin 50mg")
        self.assertEqual(inst.item[0].detail[1].productOrService.coding[0].system, "http://localdruglist.org")
        ...
        self.assertEqual(inst.item[0].detail[1].subDetail[0].productOrService.coding[0].code, "drugcost")
        self.assertEqual(inst.item[0].detail[1].subDetail[0].productOrService.coding[0].system, "http://hl7.org/fhir/ex-pharmaservice")
        self.assertEqual(inst.item[0].detail[1].subDetail[0].sequence, 1)
        self.assertEqual(inst.item[0].detail[2].net.currency, "USD")
        self.assertEqual(inst.item[0].detail[2].net.value, 28.0)
        self.assertEqual(inst.item[0].detail[2].productOrService.coding[0].code, "44057")
        self.assertEqual(inst.item[0].detail[2].productOrService.coding[0].display, "Codeine 25mg")
        self.assertEqual(inst.item[0].detail[2].productOrService.coding[0].system, "http://localdruglist.org")
        self.assertEqual(inst.item[0].detail[2].quantity.unit, "mg")
        self.assertEqual(inst.item[0].detail[2].quantity.value, 25)
        self.assertEqual(inst.item[0].detail[2].sequence, 3)
        self.assertEqual(inst.item[0].detail[2].subDetail[0].net.currency, "USD")
        self.assertEqual(inst.item[0].detail[2].subDetail[0].net.value, 28.0)
        self.assertEqual(inst.item[0].detail[2].subDetail[0].productOrService.coding[0].code, "drugcost")
        self.assertEqual(inst.item[0].detail[2].subDetail[0].productOrService.coding[0].system, "http://hl7.org/fhir/ex-pharmaservice")
        self.assertEqual(inst.item[0].detail[2].subDetail[0].sequence, 1)
        self.assertEqual(inst.item[0].detail[3].net.currency, "USD")
        self.assertEqual(inst.item[0].detail[3].net.value, 22.0)
        self.assertEqual(inst.item[0].detail[3].productOrService.coding[0].code, "markup")
        self.assertEqual(inst.item[0].detail[3].productOrService.coding[0].system, "http://hl7.org/fhir/ex-pharmaservice")
        self.assertEqual(inst.item[0].detail[3].sequence, 2)
        self.assertEqual(inst.item[0].detail[4].net.currency, "USD")
        self.assertEqual(inst.item[0].detail[4].net.value, 60.0)
        self.assertEqual(inst.item[0].detail[4].productOrService.coding[0].code, "compoundfee")
        self.assertEqual(inst.item[0].detail[4].productOrService.coding[0].system, "http://hl7.org/fhir/ex-pharmaservice")
        self.assertEqual(inst.item[0].detail[4].sequence, 3)
        self.assertEqual(inst.item[0].informationSequence[0], 1)
        self.assertEqual(inst.item[0].informationSequence[1], 2)
        self.assertEqual(inst.item[0].informationSequence[2], 3)
        self.assertEqual(inst.item[0].informationSequence[3], 4)
        self.assertEqual(inst.item[0].net.currency, "USD")
        self.assertEqual(inst.item[0].net.value, 155.0)
        self.assertEqual(inst.item[0].productOrService.coding[0].code, "compound")
        self.assertEqual(inst.item[0].productOrService.coding[0].display, "Custom compound")
        self.assertEqual(inst.item[0].productOrService.coding[0].system, "http://localdruglist.org")
        self.assertEqual(inst.item[0].quantity.code, "TAB")
        self.assertEqual(inst.item[0].quantity.system, "http://unitsofmeasure.org")
        self.assertEqual(inst.item[0].quantity.unit, "TAB")
        ...
        self.assertEqual(inst.supportingInfo[3].category.coding[0].code, "pharmacy")
        self.assertEqual(inst.supportingInfo[3].code.coding[0].code, "capsule")
        self.assertEqual(inst.supportingInfo[3].code.coding[0].system, "http://example.org/fhir/CodeSystem/pharmacy-form")
        self.assertEqual(inst.supportingInfo[3].sequence, 4)
        self.assertEqual(inst.text.div, "<div xmlns=\"http://www.w3.org/1999/xhtml\">A human-readable rendering of the Pharmacy Claim</div>")
        self.assertEqual(inst.text.status, "generated")
        self.assertEqual(inst.total.currency, "USD")
