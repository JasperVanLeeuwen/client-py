...
class ProcedureTests(unittest.TestCase):
    ...
    def implProcedure3(self, inst):
        self.assertEqual(inst.code.coding[0].code, "T1019")
        self.assertEqual(inst.code.coding[0].display, "Personal care services, per 15 minutes, not for an inpatient or resident of a hospital, nursing facility, icf/mr or imd, part of the individualized plan of treatment.")
        self.assertEqual(inst.code.coding[0].system, "https://www.cms.gov/Medicare/Coding/HCPCSReleaseCodeSets/Alpha-Numeric-HCPCS.html")
        self.assertEqual(inst.code.text, "Personal care services")
        self.assertEqual(inst.id, "HCBS")
        self.assertEqual(inst.meta.tag[0].code, "HTEST")
        self.assertEqual(inst.meta.tag[0].display, "test health data")
        self.assertEqual(inst.meta.tag[0].system, "http://terminology.hl7.org/CodeSystem/v3-ActReason")
        self.assertEqual(inst.note[0].text, "Assisted with bathing and dressing, doing laundry, and meal preparation")
